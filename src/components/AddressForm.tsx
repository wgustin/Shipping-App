...
import { parseAddressWithAI, autocompleteAddress, getAddressDetails } from '../services/apiService';
...
export const AddressForm: React.FC<AddressFormProps> = ({
  ...
  const fetchSuggestions = async (input: string) => {
    ...
    try {
      const data = await autocompleteAddress(input, controller.signal);
  ...
  const handleSelectSuggestion = async (suggestion: unknown) => {
    ...
    try {
      const data = await getAddressDetails(s.place_id);
